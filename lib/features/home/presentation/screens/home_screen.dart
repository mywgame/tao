...
import 'package:tao_boost/core/providers/referral_provider.dart'; // 👈 प्रोवाइडर पाथ भाई
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // 👈 'between' को 'spaceBetween' किया भाई
                children: [
                  Text('YOUR REFERRAL CODE:', style: TextStyle(color: Colors.white70, fontSize: 13, fontWeight: FontWeight.bold)),
                  Text('TAOBOOST777', style: TextStyle(color: neonCyan, fontSize: 16, fontWeight: FontWeight.w900, fontFamily: 'Courier')), // 👈 'black' को 'w900' किया भाई
                ],
              ),
            ),
